...
FEATURES = {
    "personalization": {
        ...
        "enforced_by": "app.domains.memory.context_summary",
    },
    "partner_access": {
        "label": "Partner access (tasks only)", "default": False,
        "enforced_by": "app.domains.partner.create_invite, app.domains.partner.accept_invite, app.domains.partner.shared",
    },
