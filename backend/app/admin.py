...
SESSION_TTL = config.ADMIN_SESSION_IDLE_TTL                # 2h idle by default
SESSION_ABSOLUTE_TTL = config.ADMIN_SESSION_ABSOLUTE_TTL   # 12h max by default
CSRF_COOKIE = "csrf_token"
SESSION_SAMESITE = config.ADMIN_COOKIE_SAMESITE
_UNSAFE_METHODS = {"POST", "PUT", "DELETE", "PATCH"}
SESSION_COOKIE_DOMAIN = config.ADMIN_COOKIE_DOMAIN
...
def init() -> None:
    ...
    pw = config.ADMIN_BOOTSTRAP_PASSWORD
    ...
    if ADMIN_SECRET == config.DEV_ADMIN_SECRET:
