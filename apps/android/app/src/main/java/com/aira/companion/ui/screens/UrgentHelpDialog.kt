    ...
    Dialog(
        ...
        Column(
            ...
            Column(
                ...
                Button(
                    onClick = {
                        // Dial the user's REAL care-team number when we have one
                        // (ACTION_DIAL needs no permission and lets them confirm);
                        // otherwise route to the emergency profile to add one,
                        // rather than dialing a hardcoded placeholder.
                        if (careTeamPhone != null) {
                            context.startActivity(
                                Intent(Intent.ACTION_DIAL, Uri.parse("tel:$careTeamPhone")),
                            )
                        } else {
                    ...
                    Text(if (careTeamPhone != null) "Call care team" else "Add a care-team number")
                }
